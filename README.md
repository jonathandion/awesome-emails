...
- [MailTester Ninja](https://mailtester.ninja) - Real-time email verification API with live SMTP checks, plus a free deliverability toolkit (inbox placement test, SPF/DKIM/DMARC checker, blacklist lookup).
