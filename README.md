...
- [MailFixture](https://mailfixture.com/) - Programmatic inboxes via API for end-to-end email testing; catches your app's mail and extracts OTPs and magic links, with Node and Python SDKs.
